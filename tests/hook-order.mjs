...
const expected = {
  ...
  "overview (routing on, narrow)": [H.Overview, "Up · 12 ms", "Claude routing", "Claude agents go through the router", "Models in Paseo", "12 synced", "Models →", "Access", "Read token", "Connection →", "Last Claude agent (", "routed through OmniRoute", "Open OmniRoute dashboard", "Sync models again", "Turn Claude routing off", "More with a manage key"],
