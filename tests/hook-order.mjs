...
const BASIC_TABS = ["Overview", "Models", "Providers", "Connection"];
const ALL_TABS = ["Overview", "Models", "Providers", "Accounts", "Usage", "Settings", "Connection"];
const H = {
  ...
  Usage: "What went through the router, per daemon, account and model.",
...
const expected = {
  ...
  "misconfigured (opens on Connection)": [H.Connection, "Not connected yet: the saved endpoint in connection.json is not a usable http(s) URL.", "The saved dashboard URL is invalid; using the default.", "1. Choose your router", "Disconnect (remove saved connection)"],
  ...
  "overview (routing on, narrow)": [H.Overview, "Up · 12 ms", "Claude routing", "Claude agents go through the router", "Models in Paseo", "7 synced", "Models →", "Access", "Read token", "Connection →", "Last Claude agent (", "routed through OmniRoute", "Open OmniRoute dashboard", "Sync models again", "Turn Claude routing off", "More with a manage key"],
  ...
  "models tab": [H.Models, "Your access", "This key", "daemon-a", "7 models on connected accounts", "Spend (monthly)", "$3.42 of $50.00", "resets 2026-10-01", "Tokens", "Claude quota", "5h: 64% left", "Sync models to Paseo", "It stays current by itself", "Remove from Paseo", "Claude 4 · Codex 3", "old \"AI Router Codex\" provider", "In Paseo's model picker", "Claude · 4", "Opus 5.5", "cc/claude-opus-5-5", "failed", "Codex · 3", "GPT-5.6 Sol", "Test", "Test another model", "Claude Code version 2.1.280 or newer is required"],
  "models tab (basic, key hides its spend)": ["Your access", "7 models on connected accounts", "lacks the self:usage scope"],
  ...
  "usage tab (in the surface)": [H.Usage, "13 requests", "By daemon", "daemon-a", "daemon-b"],
  ...
  "usage tab": ["Last 24 hours", "No requests", "Last 7 days", "13 requests", "65.3k tokens", "$0.02", "100% succeeded", "09-23", "By daemon", "this daemon", "daemon-a", "By account", "Top models", "100% failed"],
...
const expectedTabs = {
  ...
  "tab walk (operator)": {
    ...
    Usage: [H.Usage, "13 requests", "By account"],
