...
const STATES = ["setup", "overview", "overview-basic", "overview-admin", "overview-router-down", "overview-claude-paused", "models", "models-basic", "models-profiles-off", "providers", "providers-admin", "accounts-operator", "accounts-admin", "accounts-claude-paused", "usage-populated", "usage-30-days", "usage-24-hours", "usage-empty", "usage-router-down", "settings-operator", "settings-manage-key", "settings-recommended", "connection", "connection-basic", "connection-admin", "connection-router-down", "connection-misconfigured"];
